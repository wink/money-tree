[![Build Status](https://travis-ci.org/BitVault/money-tree.png)](https://travis-ci.org/BitVault/money-tree) [![Coverage Status](https://coveralls.io/repos/BitVault/money-tree/badge.png?branch=master)](https://coveralls.io/r/BitVault/money-tree?branch=master) [![Code Climate](https://codeclimate.com/github/BitVault/money-tree.png)](https://codeclimate.com/github/BitVault/money-tree) [![Gem Version](https://badge.fury.io/rb/money-tree.png)](http://badge.fury.io/rb/money-tree)
# MoneyTree
